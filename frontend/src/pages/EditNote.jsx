    ...
    <div className="card shadow p-4">
      ...
      <form onSubmit={handleSubmit} className="mt-3">
        <div className="mb-3">
          ...
          <input type="text" className="form-control" name="title" placeholder="Masukkan judul catatan"
            value={note.title} onChange={handleChange} />
        </div>
        <div className="mb-3">
          <label className="form-label">Isi Catatan</label>
          <textarea className="form-control" name="content" placeholder="Masukkan isi catatan" value={note.content}
